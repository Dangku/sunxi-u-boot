...
ifeq (x$(CONFIG_RISCV), xy)
ifeq (x$(CONFIG_ARCH_RV32I), xy)
CROSS_COMPILE := $(srctree)/../toolchain/$(RISCV_PATH)/bin/riscv32-unknown-linux-
DTS_PATH := $(srctree)/arch/riscv/dts
else
CROSS_COMPILE := $(srctree)/../toolchain/$(RISCV_PATH)/bin/riscv64-unknown-linux-gnu-
DTS_PATH := $(srctree)/arch/riscv/dts
endif
endif

ifeq (x$(CONFIG_ARM), xy)
#CROSS_COMPILE := $(srctree)/../toolchain/gcc-linaro-7.2.1-2017.11-x86_64_arm-linux-gnueabi/bin/arm-linux-gnueabi-
DTS_PATH := $(srctree)/arch/arm/dts
endif
